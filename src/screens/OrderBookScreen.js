          ...
          {challengeAccounts.length > 0 && (
            <>
              ...
              {challengeAccounts.map(acc => (
                <TouchableOpacity 
                  key={acc._id}
                  style={[styles.accountOption, { borderBottomColor: colors.border, borderLeftWidth: 3, borderLeftColor: '#d4a017' }, selectedAccount === `challenge_${acc._id}` && styles.accountOptionActive]}
