...
const NotificationsScreen = ({ navigation }) => {
  ...
  const getNotificationIcon = (type) => {
    switch (type) {
      ...
      case 'WITHDRAWAL':
        return { name: 'arrow-down-circle', color: '#d4a017', bg: '#d4a01720' };
      case 'COPY_TRADE':
...
const styles = StyleSheet.create({
  ...
  markAllText: { color: '#d4a017', fontSize: 13, fontWeight: '500' },
  ...
  unreadText: { color: '#d4a017', fontSize: 13, fontWeight: '500' },
