...
const SupportScreen = ({ navigation }) => {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      case 'OPEN': return '#d4a017';
      case 'IN_PROGRESS': return '#d4a017';
      case 'RESOLVED': return '#d4a017';
...
const styles = StyleSheet.create({
  ...
  createBtn: { backgroundColor: '#d4a017', paddingHorizontal: 24, paddingVertical: 12, borderRadius: 12, marginTop: 24 },
  ...
  priorityOptionActive: { backgroundColor: '#d4a017' },
  ...
  adminMessage: { backgroundColor: '#d4a01720', marginRight: 40 },
  messageHeader: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 4 },
  messageSender: { color: '#d4a017', fontSize: 12, fontWeight: '600' },
  ...
  sendBtn: { backgroundColor: '#d4a017', width: 44, height: 44, borderRadius: 22, justifyContent: 'center', alignItems: 'center' },
});
