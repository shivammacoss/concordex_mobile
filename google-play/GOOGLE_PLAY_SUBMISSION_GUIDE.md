# Complete Google Play Store Submission Guide for conocrddex
...
1. **Privacy Policy** → `privacy-policy.html`
   - Host at: `https://conocrddex.com/privacy-policy`
   
2. **Terms of Service** → `terms-of-service.html`
   - Host at: `https://conocrddex.com/terms-of-service`

3. **Account Deletion Policy** → `account-deletion-policy.html`
   - Host at: `https://conocrddex.com/account-deletion`

### How to host on your server:
```bash
# Copy HTML files to frontend public directory
cp privacy-policy.html ~/conocrddex/frontend/public/privacy-policy.html
cp terms-of-service.html ~/conocrddex/frontend/public/terms-of-service.html
cp account-deletion-policy.html ~/conocrddex/frontend/public/account-deletion.html

# Rebuild frontend
cd ~/conocrddex/frontend
npm run build
```
...
- Should show: App name "conocrddex", trading theme, professional look
...
2. Click "Create app"
3. Fill in:
   - **App name:** conocrddex - Trading Platform
...
#### Privacy Policy
- Enter URL: `https://conocrddex.com/privacy-policy`
...
#### Account Deletion
- Enter URL: `https://conocrddex.com/account-deletion`
...
4. Add release notes:
   ```
   Initial release of conocrddex Trading Platform
